...
;====================PROCEDIMENTO DE UPDATE TABULEIRO===================={ 
;
;   O QUE FAZ: ATUALIZA O TABULEIRO AUXILIAR E TABULEIRO DE JOGO
;
;   COMO FAZ: COMPARA A POSIÇÃO DE AMBOS TABULEIROS PARA VER SE A CASA
;   É VALIDA, CASO SEJA, ATUALIZA PARA ACERTO OU ERRO, ADEMAIS VERIFICA
;   SE EMBARCAÇÕES AFUNDARAM
;
;   NOME: UPDATE_ATAQUE 
;
;====================PROCEDIMENTO DE UPDATE TABULEIRO====================}
...
; Desenho do segundo navio (direito)
    ...
    CMP             countGeral, 6
    JE             VITORIA ;Se todas as embarcações tiverem afundadas, mostra msg de vitoria
